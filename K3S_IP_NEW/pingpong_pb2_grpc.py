...
class PingPongServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Ping = channel.unary_unary(
                ...
                response_deserializer=pingpong__pb2.PingReply.FromString,
...
def add_PingPongServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Ping': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=pingpong__pb2.PingReply.SerializeToString,
            ),
    }
...
class PingPongService(object):
    ...
    def Ping(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            pingpong__pb2.PingReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
